...
class Factory extends ClassChecker  {
     ...
     * @param string $value Value stri ng
     ...
     *
     * @param string $contextId Unique id that indentifies the configuration and used primarly
     * to name the cache files
     * @return void
     */
    protected function setCacheIdentifier($contextId) {
        $this->container->setCacheId($contextId);
    }
}
?>